...
select movie_name , budget from movies_sql order by budget asc limit 5;
...
select movie_name, lead_star, budget from movies_sql where lead_star = 'akshay kumar' order by budget asc;
